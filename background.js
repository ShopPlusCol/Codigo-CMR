...
async function b() {
  console.log("✔ domSelector desactivado.");
}
...
function A() {
  console.log("✔ URL de desinstalación desactivada.");
}

function _(e) {
  console.log("✔ Llamada de instalación desactivada.");
}
...
// URL personalizable
const miWhatsAppLink = "https://wa.me/99?text=";
const miDocumentacionLink = "http://wpres.site/crm"; 

chrome.runtime.onMessage.addListener((e, t, o) => {
  // Manejar la petición del enlace
  if (e.action === "getWhatsAppLink") {
    o({ url: miWhatsAppLink }); 
    return true; // 
  }
  if (e.action === "getDocumentationLink") {
    o({ url: miDocumentacionLink });
    return true;
  }
